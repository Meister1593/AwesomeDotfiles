...
-- Define layout icons
theme.layout_tile = gears.filesystem.get_configuration_dir() .."/icons/layouts/tiled.png"
theme.layout_floating = gears.filesystem.get_configuration_dir() .. "/icons/layouts/floating.png"
theme.layout_max = gears.filesystem.get_configuration_dir() .."/icons/layouts/maximized.png"
