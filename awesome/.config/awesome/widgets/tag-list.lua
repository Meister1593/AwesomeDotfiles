...
tag_list.create = function(s)
   return awful.widget.taglist(
      ...
      awful.util.table.join(
         ...
         -- LMB from other screen causes this to move client to new tag, very annoying
         -- TODO: Possibly removing
         ...
         --    end
         -- ),
         -- RMB - Merge multiple tag clients in one
         awful.button({}, 3,
            awful.tag.viewtoggle
         ),
         -- Meta + RMB - Not working? what's purpose of this
         -- TODO: Possibly removing
         ...
         --    end
         -- ),
         -- Scroll wheel controls, up - scroll tags up, down - scroll tags down
         awful.button({}, 4,
            function(t)
