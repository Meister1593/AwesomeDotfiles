...
local PATH_TO_ICONS = gears.filesystem.get_configuration_dir() .. "/icons/battery/"
...
local widget_button = clickable_container(wibox.container.margin(widget, widget.dpi, widget.dpi, widget.dpi, widget.dpi))
